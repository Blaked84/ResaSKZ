...
$(function() {
  ...
  $('button[type=submit]').click(function(e){
    e.preventDefault();
    var go = true
    var validators = [validate_skis(),validate_transports(),validate_assurances()]
    var toasts = document.querySelectorAll(".toast-message"); 

    // Validating transports
    if (validate_transports() == false) {
